...
const npm_config_mode = process.env.npm_config_mode || process.env.npm_config_modes || ''
const mode = npm_config_mode.split(':')
let env = !mode[1] || mode[1] === '' || mode[1] === 'hk' ? 'dd' : mode[1]
...
module.exports = ({icon})=>{
  ...
  return {
    ...
    // 多语言 默认中文 有这些可选值： http://wiki.intra.xiaojukeji.com/pages/viewpage.action?pageId=91319775
